...
describe("test common errors", function () {
    ...
    it("should use TextUtils.toMD5", function () {
        ...
        utils_1.TraceUtils.log("MD5", "Hello", x);
    });
    it("should use TextUtils.toSHA1", function () {
        ...
        utils_1.TraceUtils.log("SHA1", "Hello", x);
    });
    it("should use TextUtils.toSHA256", function () {
        ...
        utils_1.TraceUtils.log("SHA256", "Hello", x);
    });
    ...
    it("should get random Guids", function () {
        for (var i = 1; i <= 10; i++) {
            utils_1.TraceUtils.log("#" + i, utils_1.Guid.newGuid().toString());
        }
    });
    it("should use RandomUtils class", function () {
        var x = utils_1.RandomUtils.randomChars(12);
        chai_1.assert.equal(x.length, 12);
        utils_1.TraceUtils.log("Random characters", x);
        for (var i = 1; i <= 10; i++) {
            utils_1.TraceUtils.log("#" + i, utils_1.RandomUtils.randomChars(12));
        }
        var y = utils_1.RandomUtils.randomInt(0, 10);
        utils_1.TraceUtils.log("Random int", y);
        chai_1.assert.isOk((y >= 0) && (y <= 10), "Invalid random int");
        var z = utils_1.RandomUtils.randomHex(6);
        utils_1.TraceUtils.log("Random hex", z);
        for (var i = 1; i <= 10; i++) {
            utils_1.TraceUtils.log("#" + i, utils_1.RandomUtils.randomHex(6));
        }
