[@themost/common](../README.md) / [Exports](../modules.md) / HttpTokenExpiredError

# Class: HttpTokenExpiredError
...
- [constructor](httptokenexpirederror.md#constructor)

### Properties

- [innerMessage](httptokenexpirederror.md#innermessage)
- [message](httptokenexpirederror.md#message)
- [name](httptokenexpirederror.md#name)
- [stack](httptokenexpirederror.md#stack)
- [statusCode](httptokenexpirederror.md#statuscode)
- [title](httptokenexpirederror.md#title)
- [prepareStackTrace](httptokenexpirederror.md#preparestacktrace)
- [stackTraceLimit](httptokenexpirederror.md#stacktracelimit)

### Methods

- [captureStackTrace](httptokenexpirederror.md#capturestacktrace)
- [create](httptokenexpirederror.md#create)

## Constructors

### constructor

\+ **new HttpTokenExpiredError**(`message?`: *string*, `innerMessage?`: *string*): [*HttpTokenExpiredError*](httptokenexpirederror.md)
...
**Returns:** [*HttpTokenExpiredError*](httptokenexpirederror.md)

Overrides: [HttpError](httperror.md)

Defined in: [errors.d.ts:151](https://github.com/themost-framework/themost-common/blob/917834f/errors.d.ts#L151)
