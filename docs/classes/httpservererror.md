[@themost/common](../README.md) / [Exports](../modules.md) / HttpServerError
...
- [constructor](httpservererror.md#constructor)

### Properties

- [innerMessage](httpservererror.md#innermessage)
- [message](httpservererror.md#message)
- [name](httpservererror.md#name)
- [stack](httpservererror.md#stack)
- [statusCode](httpservererror.md#statuscode)
- [title](httpservererror.md#title)
- [prepareStackTrace](httpservererror.md#preparestacktrace)
- [stackTraceLimit](httpservererror.md#stacktracelimit)

### Methods

- [captureStackTrace](httpservererror.md#capturestacktrace)
- [create](httpservererror.md#create)

## Constructors

### constructor

\+ **new HttpServerError**(`message?`: *string*, `innerMessage?`: *string*): [*HttpServerError*](httpservererror.md)
...
**Returns:** [*HttpServerError*](httpservererror.md)

Overrides: [HttpError](httperror.md)

Defined in: [errors.d.ts:205](https://github.com/themost-framework/themost-common/blob/917834f/errors.d.ts#L205)
